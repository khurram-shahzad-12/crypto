...
export const Subsubcategory = ({ data }) => {

    const { getCollapseProps, getToggleProps, isExpanded } = useCollapse({
        defaultExpanded: true,
    });

    const { filterDispatch, subsubcategory } = useFilter();

    const handleSubsubCatgeoryChange = (e, option) => {
                                        ...
                                        return (
                                            <li key={index}>
                                                <Form.Check
                                                    ...
                                                    onChange={(e) => handleSubsubCatgeoryChange(e, ele.id)}
                                                    checked={subsubcategory.includes(ele.id)}
                                                />
                                            </li>
                                        )
                                    })
