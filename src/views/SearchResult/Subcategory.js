...
export const Subcategory = ({ data }) => {
    ...
    const { filterDispatch, subcategory } = useFilter();

    const handleSubCatgeoryChange = (e, option) => {
                                        ...
                                        return (
                                            <li key={index}>
                                                <Form.Check
                                                    ...
                                                    onChange={(e) => handleSubCatgeoryChange(e, ele.id)}
                                                    checked={subcategory.includes(ele.id)}
                                                />
                                            </li>
                                        )
                                    })
